...
import project.blog.community.project.mapper.WeatherMapper;
...
private final WeatherMapper mapper;
    public void getSortTermForecast(String area1, String area2) {
    ...
    urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=NJERDTgXFc7rQevpSiIhziQ6SdxzFr24scmNqSyr9E5L9Dmm4koUXmFwqemOznUrQnYDs78xvLqJyt7LUEh9zQ%3D%3D"); /*Service Key*/
    ...
    urlBuilder.append("&" + URLEncoder.encode("ny","UTF-8") + "=" + URLEncoder.encode(String.valueOf(map.get("ny")), "UTF-8")); /*예보지점의 Y 좌표값*/
            ...
            log.info("완성된 ui {}",urlBuilder.toString());
